...
List<String> componente21 = [
    ...
    '',
    'Não encontrado informações suficientes.',
    'O Tristar se comunica com os periféricos conectados ao dispositivo, gerenciando a '
];